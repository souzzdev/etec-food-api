...
CREATE TABLE TBL_ENTREGA (
    NUM_ID BIGINT PRIMARY KEY IDENTITY,
    ID_CLIENTE BIGINT NOT NULL,
    TX_CEP VARCHAR(8),
    TX_ENDERECO VARCHAR(50),
    TX_COMPLEMENTO VARCHAR(30),
    FOREIGN KEY (ID_CLIENTE) REFERENCES Cliente(ID_CLIENTE),
 --   FOREIGN KEY (FK_ID_PEDIDO) ,
 --   FOREIGN KEY (entregador_id) 
);
ALTER TABLE TBL_ENTREGA ADD FK_ID_PEDIDO BIGINT NOT NULL REFERENCES Pedido(id);

ALTER TABLE TBL_ENTREGA ADD FK_ID_ENT BIGINT NOT NULL REFERENCES Entregador(id);
